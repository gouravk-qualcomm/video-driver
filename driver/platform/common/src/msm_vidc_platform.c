...
static const struct msm_vidc_compat_handle compat_handle[] = {
	...
	},
	{
		...
		.get_platform_data          = msm_vidc_get_platform_data_glymur,
		.init_platform              = msm_vidc_init_platform_glymur,
		.init_iris                  = msm_vidc_init_glymur_iris36,
	},
#endif
#if defined(CONFIG_MSM_VIDC_LEMANS)
	{
