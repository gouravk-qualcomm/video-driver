...
static struct codec_info codec_data_glymur[] = {
	{
...
static struct color_format_info color_format_data_glymur[] = {
	{
...
static struct color_primaries_info color_primaries_data_glymur[] = {
	{
...
static struct transfer_char_info transfer_char_data_glymur[] = {
	{
...
static struct matrix_coeff_info matrix_coeff_data_glymur[] = {
	{
...
static const struct msm_platform_core_capability core_data_glymur[] = {
	/* {type, value} */
...
static struct msm_platform_inst_capability instance_cap_data_glymur[] = {
	/* {cap, domain, codec,
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_glymur[] = {
	/* {cap, domain, codec,
	 *      parents,
	 *      children,
	 *      adjust, set}
	...
	{IR_PERIOD, ENC, H264 | HEVC,
		{0},
		msm_vidc_adjust_ir_period_glymur,
		msm_vidc_set_ir_period_glymur},
...
static struct msm_vidc_format_capability format_data_glymur = {
	.codec_info = codec_data_glymur,
	.codec_info_size = ARRAY_SIZE(codec_data_glymur),
	.color_format_info = color_format_data_glymur,
	.color_format_info_size = ARRAY_SIZE(color_format_data_glymur),
	.color_prim_info = color_primaries_data_glymur,
	.color_prim_info_size = ARRAY_SIZE(color_primaries_data_glymur),
	.transfer_char_info = transfer_char_data_glymur,
	.transfer_char_info_size = ARRAY_SIZE(transfer_char_data_glymur),
	.matrix_coeff_info = matrix_coeff_data_glymur,
	.matrix_coeff_info_size = ARRAY_SIZE(matrix_coeff_data_glymur),
};

/* name, min_kbps, max_kbps */
static const struct bw_table glymur_bw_table[] = {
	{ "cpu-cfg",     1000, 1000     },
	{ "video-mem",   1000, 15000000 },
};

/* name */
static struct pd_table glymur_pd_table[] = {
	{ "venus",     0, 1 },
	{ "vcodec0",   1, 1 },
	{ "vcodec1",   1, 1 },
};
...
/* name */
static const char * const glymur_opp_pd_table[] = {
	"mxc",
	"mmcx",
	NULL
};
...
static const struct clk_table glymur_clk_table[] = {
	...
	{ "vcodec0_iface",        GCC_VIDEO_AXI0_CLK,         0 },
	{ "core_freerun",         VIDEO_CC_MVS0C_FREERUN_CLK, 0 },
	{ "vcodec0_core_freerun", VIDEO_CC_MVS0_FREERUN_CLK,  0 },
	{ "vcodec1_iface",        GCC_VIDEO_AXI1_CLK,         0 },
...
static const struct clk_rst_table glymur_clk_reset_table[] = {
	{ "core_bus",     0 },
	{ "vcodec0_bus",  0 },
	{ "core",         0 },
	{ "vcodec0_core", 0 },
...
const struct context_bank_table glymur_context_bank_table[] = {
	{"qcom,vidc,cb-ns",            0x25800000, 0xda600000, 0, 1,
		MSM_VIDC_NON_SECURE | MSM_VIDC_NON_SECURE_BITSTREAM, 0 },
	{"qcom,vidc,cb-ns-pxl",        0x00200000, 0xffc00000, 0, 1, MSM_VIDC_NON_SECURE_PIXEL, 0 },
	{"qcom,vidc,cb-sec-pxl",       0x00200000, 0xffc00000, 1, 0, MSM_VIDC_SECURE_PIXEL,     0 },
	...
	{"qcom,vidc,cb-firmware",      0x00000000, 0x01000000, 1, 0, MSM_VIDC_SECURE_FIRMWARE,  0 },
};

/* register, value, mask */
static const struct reg_preset_table glymur_reg_preset_table[] = {
	{ 0xB0088, 0x0, 0x3f },
};

/* decoder properties */
static const u32 glymur_vdec_psc_avc[] = {
...
static const u32 glymur_vdec_psc_hevc[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 glymur_vdec_psc_vp9[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 glymur_vdec_psc_av1[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 glymur_vdec_input_properties_avc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
};

static const u32 glymur_vdec_input_properties_hevc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
};

static const u32 glymur_vdec_input_properties_vp9[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
};

static const u32 glymur_vdec_input_properties_av1[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
...
static const u32 glymur_vdec_output_properties_avc[] = {
...
static const u32 glymur_vdec_output_properties_hevc[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_DPB_LIST,
...
static const u32 glymur_vdec_output_properties_vp9[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_DPB_LIST,
...
static const u32 glymur_vdec_output_properties_av1[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_DPB_LIST,
...
static const u32 glymur_msm_vidc_ssr_type[] = {
	HFI_SSR_TYPE_SW_ERR_FATAL,
};

static int msm_vidc_glymur_init_cb_devs(struct msm_vidc_core *core)
{
	static const struct {
		const char *cb_name;
		const char *cb_node_name;
	} glymur_cb_fid[] = {
		{ "qcom,vidc,cb-ns",     "non-pixel" },
		{ "qcom,vidc,cb-ns-pxl", "pixel"     },
	};
	struct context_bank_info *cb;
	int i, rc;

	venus_hfi_for_each_context_bank(core, cb) {
		for (i = 0; i < ARRAY_SIZE(glymur_cb_fid); i++) {
			if (strcmp(cb->name, glymur_cb_fid[i].cb_name))
				continue;

			rc = msm_vidc_create_child_device_and_map(core, cb, 0,
								  glymur_cb_fid[i].cb_node_name);
			if (rc) {
...
static const struct msm_vidc_platform_data glymur_data = {
	/* resources dependent on other module */
	.bw_tbl = glymur_bw_table,
	.bw_tbl_size = ARRAY_SIZE(glymur_bw_table),
	.pd_tbl = glymur_pd_table,
	.pd_tbl_size = ARRAY_SIZE(glymur_pd_table),
	.opp_tbl = glymur_opp_pd_table,
	.opp_tbl_size = ARRAY_SIZE(glymur_opp_pd_table),
	...
	.context_bank_tbl = glymur_context_bank_table,
	.context_bank_tbl_size = ARRAY_SIZE(glymur_context_bank_table),
	/* platform specific resources */
	.reg_prst_tbl = glymur_reg_preset_table,
	.reg_prst_tbl_size = ARRAY_SIZE(glymur_reg_preset_table),
	...
	.core_data = core_data_glymur,
	.core_data_size = ARRAY_SIZE(core_data_glymur),
	.inst_cap_data = instance_cap_data_glymur,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_glymur),
	.inst_cap_dependency_data = instance_cap_dependency_data_glymur,
	.inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_glymur),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
	.csc_data.vpe_csc_custom_limit_coeff = vpe_csc_custom_limit_coeff,
	.format_data = &format_data_glymur,

	/* decoder properties related*/
	.psc_avc_tbl = glymur_vdec_psc_avc,
	.psc_avc_tbl_size = ARRAY_SIZE(glymur_vdec_psc_avc),
	.psc_hevc_tbl = glymur_vdec_psc_hevc,
	.psc_hevc_tbl_size = ARRAY_SIZE(glymur_vdec_psc_hevc),
	.psc_vp9_tbl = glymur_vdec_psc_vp9,
	.psc_vp9_tbl_size = ARRAY_SIZE(glymur_vdec_psc_vp9),
	.psc_av1_tbl = glymur_vdec_psc_av1,
	.psc_av1_tbl_size = ARRAY_SIZE(glymur_vdec_psc_av1),
	.dec_input_prop_avc = glymur_vdec_input_properties_avc,
	.dec_input_prop_hevc = glymur_vdec_input_properties_hevc,
	.dec_input_prop_vp9 = glymur_vdec_input_properties_vp9,
	.dec_input_prop_av1 = glymur_vdec_input_properties_av1,
	.dec_input_prop_size_avc = ARRAY_SIZE(glymur_vdec_input_properties_avc),
	.dec_input_prop_size_hevc = ARRAY_SIZE(glymur_vdec_input_properties_hevc),
	.dec_input_prop_size_vp9 = ARRAY_SIZE(glymur_vdec_input_properties_vp9),
	.dec_input_prop_size_av1 = ARRAY_SIZE(glymur_vdec_input_properties_av1),
	.dec_output_prop_avc = glymur_vdec_output_properties_avc,
	.dec_output_prop_hevc = glymur_vdec_output_properties_hevc,
	.dec_output_prop_vp9 = glymur_vdec_output_properties_vp9,
	.dec_output_prop_av1 = glymur_vdec_output_properties_av1,
	.dec_output_prop_size_avc = ARRAY_SIZE(glymur_vdec_output_properties_avc),
	.dec_output_prop_size_hevc = ARRAY_SIZE(glymur_vdec_output_properties_hevc),
	.dec_output_prop_size_vp9 = ARRAY_SIZE(glymur_vdec_output_properties_vp9),
	.dec_output_prop_size_av1 = ARRAY_SIZE(glymur_vdec_output_properties_av1),
	.msm_vidc_ssr_type = glymur_msm_vidc_ssr_type,
	.msm_vidc_ssr_type_size = ARRAY_SIZE(glymur_msm_vidc_ssr_type),
	.init_cb_devs = msm_vidc_glymur_init_cb_devs,
};

static int msm_vidc_glymur_check_ddr_type(void)
{
	return 0;
}
...
{
	d_vpr_h("%s: initialize glymur data\n", __func__);
	core->platform->data = glymur_data;
...
int msm_vidc_init_platform_glymur(struct msm_vidc_core *core)
{
	...
	d_vpr_h("%s: initialize glymur ops\n", __func__);
	rc = msm_vidc_glymur_check_ddr_type();
	if (rc)
		return rc;
